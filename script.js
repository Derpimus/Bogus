...
var give = ['Makrzak','Knach','Adelka','Piosik','Seyda','Ewa','Zuzia','Michal','Emilka','Dzięgo','Apollo','Mareł','Tocha','Ineł','Artur','Sawko','Kacper','Beon','Owoc'];
...
function drawList()
{
	people.innerHTML = '<option value="">Kto losuje?</option>';
...
function selectPerson(person) 
{
	...
	result.innerHTML += "<h2>" + name + " kupuje prezent " + recipientName + "!</h2>";
	if(give.length > 0)
	{
		drawList();
	}
